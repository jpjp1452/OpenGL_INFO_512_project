...
private:
    ...
    {   
        std::cout << "Compiling shader of type1 " << shaderType << "..." << std::endl;
        GLuint shader = glCreateShader(shaderType);
        std::cout << "Compiling shader of type2 " << shaderType << "..." << std::endl;
        const char* code = shaderCode.c_str();
        std::cout << "Compiling shader of type3 " << shaderType << "..." << std::endl;
